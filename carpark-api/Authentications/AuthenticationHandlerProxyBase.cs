...
Console.WriteLine($"DEBUG2-1 - [{jwtStr}]");
            ...
            var credentialBytes = Convert.FromBase64String(jwtStr);
...
Console.WriteLine($"DEBUG1-1 JWT --> [{authHeader.Parameter}]");
try
{
